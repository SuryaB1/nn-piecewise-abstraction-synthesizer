...
for i in range(20):
    ...
    # 0.9999999999999895*x0 + 1.0*x1 >= 19.88894349169395
    ...
    if i % 2:
        ...
        eq8.addAddend(0.9999999999999895, inputVars[0])
        eq8.addAddend(1.0, inputVars[1])
        eq8.setScalar(19.88894349169395)
        network.addEquation(eq8, isProperty=True)
    ...
    # -1.2074084055251597*x0 + 1.0*x1 >= -2.2222287419399382
    ...
    if i <= 1:
        ...
        eq10.addAddend(-1.2074084055251597, inputVars[0])
        eq10.addAddend(1.0, inputVars[1])
        eq10.setScalar(-2.2222287419399382)
